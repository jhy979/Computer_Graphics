...
int flag_screen_effect = 1;
float screen_frequency = 1.0f, screen_width = 0.1f;
...
void prepare_floor(void) { // Draw coordinate axes.
	...
	material_floor.ambient_color[1] = 0.00f;
	...
	if (funny_effect == 1)
		My_glTexImage2D_from_file("Data/static_objects/red.jpg");
	else
		My_glTexImage2D_from_file("Data/static_objects/ground.jpg");
...
void prepare_wolf(void) {
	...
	if (funny_effect == 1)
		My_glTexImage2D_from_file("Data/static_objects/magma2.jpg");
	else
...
void prepare_optimus(void) {
	...
	if (funny_effect == 1)
		...
		My_glTexImage2D_from_file("Data/static_objects/aa.jpg");
...
void prepare_bus(void) {
	...
	material_bus.ambient_color[0] = 0.5f;
	material_bus.ambient_color[1] = 0.5f;
	material_bus.ambient_color[2] = 0.5f;
	material_bus.ambient_color[3] = 1.0f;
	//
	material_bus.diffuse_color[0] = 0.5f;
	material_bus.diffuse_color[1] = 0.5f;
	material_bus.diffuse_color[2] = 0.5f;
	...
	if (funny_effect == 1)
		...
		My_glTexImage2D_from_file("Data/static_objects/green.jpg");
...
void prepare_ironman(void) {
	...
	//
	material_ironman.diffuse_color[0] = 0.4f;
	material_ironman.diffuse_color[1] = 0.4f;
	material_ironman.diffuse_color[2] = 0.4f;
	material_ironman.diffuse_color[3] = 1.0f;
	//
	material_ironman.specular_color[0] = 0.4f;
	material_ironman.specular_color[1] = 0.4f;
	material_ironman.specular_color[2] = 0.6f;
	...
	material_ironman.emissive_color[2] = 0.1f;
	...
	if (flag_choice_mapping == 0)
		My_glTexImage2D_from_file("Data/dynamic_objects/tiger/tiger_tex2.jpg");
	else
		My_glTexImage2D_from_file("Data/static_objects/123.jpg");
	glGenerateMipmap(GL_TEXTURE_2D);
